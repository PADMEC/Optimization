...
%  Method='R2DOmc' , %PC method with FORM
...
%  obj_type{4+main_object}='single';
  ...
  i_obj = 264; %specific [0,120;8.5605,119.6930]
%  arq.tobj=1;%vol
 %arq.tobj=2;%energy
...
RandVarDist(2,1:3)=[0,0,1]; % Mu par1 (F, +20, +40)
RandVarDist(3,1:3)=[.5,.2,.2]; % std par2 (F, *20 = 10,4)
