...
%POD Robust
% Obj 6 - St D displ
%arq.x0 = [0.2630    0.6234    1.7376];%  0.4124
% Obj 2 - Mean displ
%arq.x0 = [0.1465    0.7337    1.6860];% 0.3859 x 0.392424
...
% 1 VOLUME, 2 FLAMBAGEM GLOBAL, 3 FLAMBAGEM LOCAL, 4 TENSAO, 
...
if strcmp(ResType{iconst},'probability')
