function [D,F,ZKs,Cs,Toff,x0s,niters]=OfflinePOD(arq,props,fext,glb,tipo,n)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     offline_stage=1;
    ...
    for i=1:nR
        ...
        if Stochast_on
            ...
            varargin_i=RandomStructDef(Xrv(i,:),varargin0{:});
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        else
        ...
        [Fs,Us,Sigs,ien,ivol,~,~,Ks]=NLfesol(varargin_i{:});
        nitt0=sum(niters);
        niters(i)=size(Us,2);
